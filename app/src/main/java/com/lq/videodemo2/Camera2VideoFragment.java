...
public class Camera2VideoFragment extends Fragment
    ...
    private static int minDuration = 3000;    //最小录制时间
...
//        }
    ...
    private void stopRecordingVideo() {
        if (recorderTime < minDuration) {
            Activity activity = getActivity();
            if (null != activity) {
                Toast.makeText(activity, "录制时间太短！",
            ...
            mMediaRecorder.stop();
            deleteFile(getVideoFilePath(getActivity()));
        ...
        Toast.makeText(mainActivity, "Video saved: " + mVideoPath,
                Toast.LENGTH_SHORT).show();
        Log.i(TAG, "Video saved: " + mVideoPath);
